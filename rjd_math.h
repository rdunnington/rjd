...
#define rjd_math_float3_shuffle(f3, x, y, z) ((rjd_math_float3){_mm_shuffle_ps((f3).v, (f3).v, _MM_SHUFFLE(z, z, y, x))})

static inline rjd_math_float3 rjd_math_float3_zero(void);
static inline rjd_math_float3 rjd_math_float3_xyz(float x, float y, float z);
static inline rjd_math_float3 rjd_math_float3_splat(float v);
static inline rjd_math_float3 rjd_math_float3_one(void);
static inline rjd_math_float3 rjd_math_float3_up(void);
static inline rjd_math_float3 rjd_math_float3_down(void);
static inline rjd_math_float3 rjd_math_float3_left(void);
static inline rjd_math_float3 rjd_math_float3_right(void);
static inline rjd_math_float3 rjd_math_float3_forward(void);
static inline rjd_math_float3 rjd_math_float3_back(void);
static inline rjd_math_float3 rjd_math_float3_yzx(rjd_math_float3 v);
static inline rjd_math_float3 rjd_math_float3_zxy(rjd_math_float3 v);
static inline rjd_math_float3 rjd_math_float3_setx(rjd_math_float3 v, float x);
static inline rjd_math_float3 rjd_math_float3_sety(rjd_math_float3 v, float y);
static inline rjd_math_float3 rjd_math_float3_setz(rjd_math_float3 v, float z);
static inline float 		  rjd_math_float3_x(rjd_math_float3 v);
static inline float 		  rjd_math_float3_y(rjd_math_float3 v);
static inline float 		  rjd_math_float3_z(rjd_math_float3 v);
static inline float 		  rjd_math_float3_sum(rjd_math_float3 v);
static inline float 		  rjd_math_float3_dot(rjd_math_float3 a, rjd_math_float3 b);
static inline float 		  rjd_math_float3_angle(rjd_math_float3 a, rjd_math_float3 b);
static inline float 		  rjd_math_float3_lengthsq(rjd_math_float3 v);
static inline float 		  rjd_math_float3_length(rjd_math_float3 v);
static inline rjd_math_float3 rjd_math_float3_normalize(rjd_math_float3 v);
static inline rjd_math_float3 rjd_math_float3_scale(rjd_math_float3 v, float s);
static inline rjd_math_float3 rjd_math_float3_add(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_sub(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_mul(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_div(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_cross(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_min(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_max(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_project(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_reflect(rjd_math_float3 a, rjd_math_float3 b);
static inline rjd_math_float3 rjd_math_float3_lerp(rjd_math_float3 a, rjd_math_float3 b, float t);
static inline bool			  rjd_math_float3_eq(rjd_math_float3 a, rjd_math_float3 b);
	...
	#define float3_splat    	rjd_math_float3_splat
	...
	#define float3_shuffle  	rjd_math_float3_shuffle
	#define float3_yzx      	rjd_math_float3_yzx
	#define float3_zxy      	rjd_math_float3_zxy
	...
	#define float3_sum      	rjd_math_float3_sum
	#define float3_dot      	rjd_math_float3_dot
	#define float3_angle    	rjd_math_float3_angle
	...
	#define float3_mul      	rjd_math_float3_mul
	#define float3_div      	rjd_math_float3_div
	...
	#define float3_eq       	rjd_math_float3_eq
#endif
...
static inline rjd_math_float3 rjd_math_float3_zero(void) { 
	rjd_math_float3 v = { _mm_setzero_ps() };
	return v;
}
static inline rjd_math_float3 rjd_math_float3_xyz(float x, float y, float z) {
	rjd_math_float3 v = { _mm_set_ps(0, z, y, x) }; 
	return v;
}
static inline rjd_math_float3 rjd_math_float3_splat(float v) { return rjd_math_float3_xyz(v,v,v); }
static inline rjd_math_float3 rjd_math_float3_one(void) { return rjd_math_float3_xyz(1,1,1); }
static inline rjd_math_float3 rjd_math_float3_up(void) { return rjd_math_float3_xyz(0,1,0); }
static inline rjd_math_float3 rjd_math_float3_down(void) { return rjd_math_float3_xyz(0,-1,0); }
static inline rjd_math_float3 rjd_math_float3_left(void) { return rjd_math_float3_xyz(-1,0,0); }
static inline rjd_math_float3 rjd_math_float3_right(void) { return rjd_math_float3_xyz(1,0,0); }
static inline rjd_math_float3 rjd_math_float3_forward(void) { return rjd_math_float3_xyz(0,0,1); }
static inline rjd_math_float3 rjd_math_float3_back(void) { return rjd_math_float3_xyz(0,0,-1); }
static inline rjd_math_float3 rjd_math_float3_yzx(rjd_math_float3 v) {
...
static inline float rjd_math_float3_dot(rjd_math_float3 a, rjd_math_float3 b) {
	rjd_math_float3 product = rjd_math_float3_mul(a,b);
...
static inline rjd_math_float3 rjd_math_float3_normalize(rjd_math_float3 v) {
	...
	RJD_ASSERT(length != 0);
	rjd_math_float3 l = rjd_math_float3_splat(length);
	return rjd_math_float3_div(v, l);
}
static inline rjd_math_float3 rjd_math_float3_scale(rjd_math_float3 v, float s) {
	rjd_math_float3 scales = rjd_math_float3_splat(s);
...
static inline rjd_math_float3 rjd_math_float3_cross(rjd_math_float3 a, rjd_math_float3 b) {
	rjd_math_float3 ap = rjd_math_float3_mul(rjd_math_float3_yzx(a), rjd_math_float3_zxy(b));
	rjd_math_float3 bp = rjd_math_float3_mul(rjd_math_float3_zxy(a), rjd_math_float3_yzx(b));
...
static inline rjd_math_float3 rjd_math_float3_reflect(rjd_math_float3 v, rjd_math_float3 n) {
	RJD_ASSERT(rjd_math_float3_eq(n, rjd_math_float3_normalize(n)));
	rjd_math_float3 projected = rjd_math_float3_scale(n, 2 * rjd_math_float3_dot(v, n));
	return rjd_math_float3_sub(v, projected);
}
static inline rjd_math_float3 rjd_math_float3_lerp(rjd_math_float3 a, rjd_math_float3 b, float t) {
	rjd_math_float3 v = rjd_math_float3_sub(b, a);
